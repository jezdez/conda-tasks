"""Tests for conda_tasks.graph."""

from __future__ import annotations

import pytest

from conda_tasks.exceptions import CyclicDependencyError, TaskNotFoundError
from conda_tasks.graph import resolve_execution_order
